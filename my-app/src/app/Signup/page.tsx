    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900 px-4">
      <div className="w-full max-w-md bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg">
        ...
        <button
          type="button"
          onClick={onReset}
          className="w-full bg-red-600 text-white py-2 px-4 rounded-xl hover:bg-red-700 transition duration-300 font-semibold mt-4"
        >
          Reset Password
        </button>
        <div className="w-full bg-red-600 text-white py-2 px-4 rounded-xl hover:bg-red-700 transition duration-300 font-semibold mt-4">
